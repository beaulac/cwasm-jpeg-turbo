...
# Release build
RUN ["clang",\
 "--sysroot=/share/wasi-sysroot", "--target=wasm32-unknown-wasi",\
 "-Iinclude/","-Ilibjpeg-turbo/", "-flto", "-Ofast",\
 "-o", "jpeg-turbo.wasm",\
 "-DWITH_SIMD=0", "-nostartfiles", "-fvisibility=hidden", \
 "-Wl,--no-entry,--demangle,--allow-undefined,--export=malloc,--export=free,--export=tjFree,--export=tjInitDecompress,--export=tjDecompressHeader3,--export=tjDecompress2,--export=tjInitCompress,--export=tjCompress2,--export=tjDestroy,--strip-all", \
 "--", \
